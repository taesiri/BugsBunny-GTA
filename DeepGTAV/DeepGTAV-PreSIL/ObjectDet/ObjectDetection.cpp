...
const int STENCIL_TYPE_TRAFFIC_LIGHT = 4;
const int STENCIL_TYPE_TRAFFIC_SIGN = 5;
const int STENCIL_TYPE_PROP = 6;
const int STENCIL_TYPE_BUILDING = 7;
const std::vector<int> KNOWN_STENCIL_TYPES = { STENCIL_TYPE_DEFAULT, STENCIL_TYPE_NPC, STENCIL_TYPE_VEHICLE, STENCIL_TYPE_VEGETATION, STENCIL_TYPE_FLOOR, STENCIL_TYPE_SKY, STENCIL_TYPE_SELF, STENCIL_TYPE_OWNCAR, STENCIL_TYPE_UNDERGROUND_ENTRANCE, STENCIL_TYPE_TRAFFIC_LIGHT, STENCIL_TYPE_TRAFFIC_SIGN, STENCIL_TYPE_PROP, STENCIL_TYPE_BUILDING };
...
void ObjectDetection::setupLiDAR() {
    ...
    if (pointclouds && !lidar_initialized) //flag if activate the LiDAR
    {
        ...
        lidar.Init3DLiDAR_FOV(m_max_lidar_dist, 180.0f, 0.09f, 180.0f, 0.420f, 0.0f);
